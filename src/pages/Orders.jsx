...
const Orders = () => {
    const {prooducts,currency} = useContext(ShopContext);
    return (
            ...
            <div>
                {
                    products.slice(1,4).map((item,index)=>(
                        <div key={index} className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center mf:justify-between gap-4'>
